        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(children).remove();
                    text = $(this).text();
                    if(options.checkboxshow){
                    	if($.inArray($(this).data("code"), options.checkboxInitList) >= 0 ){
                    		$(this).html('<span><input type="checkbox" name="'+$(this).data("code")+'" value="'+$(this).data("code")+'" checked/><span class="glyphicon"></span><a href="javascript: void(0); " ></a> </span>');
                    	}else{
                    		$(this).html('<span><input type="checkbox" name="'+$(this).data("code")+'" value="'+$(this).data("code")+'"/><span class="glyphicon"></span><a href="javascript: void(0); " ></a> </span>');
                    	}
                    	
                    }else{
                    	$(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0); " onclick="loading(\''+$(this).data("code")+'\')" ></a> </span>');
                    }
                    ...
                    if(options.checkboxshow){
                    	if($.inArray($(this).data("code"), options.checkboxInitList) >= 0 ){
                    		$(this).html('<span><input type="checkbox" name="'+$(this).data("code")+'" value="'+$(this).data("code")+'" checked/><span class="glyphicon"></span><a href="javascript: void(0);" onclick="loading(\''+$(this).data("code")+'\')"></a> </span>');
                    	}else{
                    		$(this).html('<span><input type="checkbox" name="'+$(this).data("code")+'" value="'+$(this).data("code")+'"/><span class="glyphicon"></span><a href="javascript: void(0);" onclick="loading(\''+$(this).data("code")+'\')"></a> </span>');
                    	}
