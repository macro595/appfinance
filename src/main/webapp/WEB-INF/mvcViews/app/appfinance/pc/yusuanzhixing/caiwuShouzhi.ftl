...
<input type="hidden" id="item" value="caiwushouzhi_menu"/>
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <thead>
            	<tr>
	                ...
	                <th>本月实际<br/>
	                Monthly actual data</th>
	                <th class="phone,hide">本月预算<br/>Monthly budget</th>
	                <th class="phone,hide">完成预算<br/>Completion ratio</th>
	                <th class="phone,hide">上月实际<br/>actual last month</th>
            ...
            <#if (datalist?size>0) >
	                ...
	                <td >${(data.shiji)!}</td>
	                <td class="center">${(data.yusuan)!}</td>
	                <td class="center">${(data.yusuanShijiBi)!}</td>
	                <td class="center">${(data.preShiji)!}</td>
	                <td class="center">${(data.tongBi)!}%</td>
	                <#break>
	                </#if>
...
<script>
    ...
    function filer(){
    	...
    	window.location.href = "${servePath}/pc/report/caiwushouzhi/"+year + "/" + month;
    }
