...
public class ExchangeMail {
	...
	private static String username = "chzh.xiao@hnair.com";
	private static String password = "qwe.123";
	private static String demand = "E14CASCM06.HNA.NET";// 邮件服务器
